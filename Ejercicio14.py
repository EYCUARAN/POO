...
class PersonalAgendaApp:
    def __init__(self, root):  # Constructor corregido
...
if __name__ == "__main__":  #Corrgido ahi  Corrección aquí
    root = tk.Tk()
    app = PersonalAgendaApp(root)
    root.mainloop()  # Agregado para iniciar el bucle principal de la interfaz